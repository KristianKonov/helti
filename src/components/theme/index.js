...
export const darkTheme = {
    ...
    // webkitbg: '-webkit-linear-gradient(90deg, rgba(0, 7, 28, 1) 15%, rgba(0, 11, 43, 1) 50%, rgba(0, 7, 28, 1) 85%)',
    // olinearbg: '-o-linear-gradient(90deg, rgba(0, 7, 28, 1) 15%, rgba(0, 11, 43, 1) 50%, rgba(0, 7, 28, 1) 85%)',
    // mslinearbg: '-ms-linear-gradient(90deg, rgba(0, 7, 28, 1) 15%, rgba(0, 11, 43, 1) 50%, rgba(0, 7, 28, 1) 85%)',
    // lineargrad: 'linear-gradient(90deg, rgba(0, 7, 28, 1) 15%, rgba(0, 11, 43, 1) 50%, rgba(0, 7, 28, 1) 85%)',
    // filterbg: 'progid:DXImageTransform.Microsoft.gradient( startColorstr="#00071C", endColorstr="#00071C", GradientType=0 )',
}